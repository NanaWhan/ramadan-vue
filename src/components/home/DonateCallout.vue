<template>
  <section id="donate" class="relative py-28 text-white">
    ...
    <div class="absolute inset-0 bg-gradient-to-r from-dark-color/80 to-dark-color/70 z-0"></div>
    <img 
      :src="bannerImage" 
    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="max-w-3xl mx-auto text-center">
        <h2 class="text-4xl md:text-5xl font-bold mb-4" data-aos="fade-up">Make a Difference Today</h2>
        <div class="w-24 h-1 bg-accent-color mx-auto mb-6" data-aos="fade-up" data-aos-delay="100"></div>
        <p class="text-xl text-gray-200 mb-10" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="space-y-6" data-aos="fade-up" data-aos-delay="300">
          <div class="bg-white/10 backdrop-blur-sm p-6 rounded-xl mb-6">
            <div class="text-4xl font-bold text-accent-color mb-2">GHS 1,000</div>
            <p class="text-gray-200 mb-4">Can feed 20 people for the entire month</p>
          ...
          <p class="text-sm text-gray-300">
            Need a different amount? <a href="/donate" class="text-accent-color underline hover:text-yellow-400">Visit our donation page</a> for more options.
          </p>
        </div>
      </div>
    </div>
