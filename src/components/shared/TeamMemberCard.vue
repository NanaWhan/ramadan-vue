<template>
  <div class="bg-white rounded-xl shadow-md p-6 h-full text-center transition-all duration-300 hover:shadow-lg hover:-translate-y-2">
    <div class="mb-5 flex justify-center">
      <div class="w-28 h-28 rounded-full overflow-hidden border-4 shadow-md" :class="borderClass">
        <img 
    ...
    <div class="mt-4 flex justify-center space-x-3">
      <a href="#" class="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-accent-color hover:text-dark-color transition-colors">
